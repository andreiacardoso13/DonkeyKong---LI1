...
getImages = do
               ...
               let images = [(Ladder,escada), (Trapdoor,alcapao), (Platform,plataforma), (Estrela,estrela),
                             ...
                             (PlCriaMapa,plCriaMapa), (Quadrado,quadrado), (Score,score), (Bonus,bonus)]
               return images