...
getImages = do
               ...
               let images = [(Ladder,escada), (Trapdoor,alcapao), (Platform,plataforma), (Estrela,estrela),
                             ...
                             (Creditos,creditos), (DicasPausa,dicasPausa), (ImEditorMapas,editorMapas), (Quadrado,quadrado), 
                             (PlCriaMapa,plCriaMapa), (PausaControlos, pausaControlos)]
               return images