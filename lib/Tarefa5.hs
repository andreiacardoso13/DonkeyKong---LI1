...
keys (EventKey (SpecialKey KeyUp)    Down _ _) e@(Estado {jogo = j@(Jogo {mapa = m@(Mapa _ _ blocos), 
                                                                          jogador = jgd@(Personagem {posicao = pos@(x,y), 
                                                                                                     ...
                                                                                                     aplicaDano = (b,_)})})}) | b = e
                                                                                                                              ...
                                                                                                                              | not esc && procuraBloco blocos pos == Escada && mod' x 1 /= 0            = e {jogo = j {jogador = movePersonagem jgd (Just Subir)}}
...
keys (EventKey (SpecialKey KeyDown)  Down _ _) e@(Estado {jogo = j@(Jogo {mapa = m@(Mapa _ _ blocos), 
                                                                          jogador = jgd@(Personagem {posicao = pos@(x,y), 
                                                                                                     ...
                                                                                                     aplicaDano = (b,_)})})}) | b = e 
                                                                                                                              ...
                                                                                                                              |not esc  && procuraBlocoInf blocos pos == Plataforma && procuraBloco blocos (x,y+2) == Escada     && mod' x 1 /= 0 = e {jogo = j {jogador = movePersonagem jgd (Just Descer)}}
