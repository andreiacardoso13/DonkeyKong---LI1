...
=Exemplos
>>>valida (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Escada,Alcapao,Vazio],[Escada,Vazio,Plataforma],[Plataforma,Plataforma,Plataforma]],inimigos = [Personagem {tipo = Fantasma,posicao = (1,1),ressalta = True,vida = 1},Personagem {tipo = Fantasma,posicao = (0,0),ressalta = True,vida = 1}],colecionaveis = [(Martelo, (1,1)),(Moeda, (2,0))],jogador = Personagem {posicao = (2,0),tamanho = (1,2),ressalta = False}})=True
-}
...
=Exemplos
>>> validaChao (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Plataforma,Plataforma]]})=True
>>> validaChao (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Vazio,Vazio,Escada],[Alcapao,Plataforma,Plataforma]]})=False
>>> validaChao (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Vazio,Vazio,Escada],[Escada,Plataforma,Plataforma]]})=False
-}
...
=Exemplos
>>> validaEscadas (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Escada,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Plataforma,Vazio,Plataforma]]})= True
>>> validaEscadas (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Alcapao,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Plataforma,Vazio,Plataforma]]})0 = False
>>> validaEscadas (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Escada,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Escada,Vazio,Plataforma]]}) = False
>>> validaEscadas (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Plataforma,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Alcapao,Vazio,Plataforma]]}) = False
-}
...
=Exemplos
>>> validaEscadasAlcapao (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Plataforma,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Vazio,Vazio,Plataforma]]}) =True
>>> validaEscadasAlcapao (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Plataforma,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Alcapao,Vazio,Plataforma]]})=False
>>> validaEscadasAlcapao (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Plataforma,Alcapao,Vazio,Escada],[Escada,Escada,Escada,Plataforma],[Vazio,Escada,Plataforma,Vazio],[Alcapao,Vazio,Vazio,Plataforma]]})=False                                                         
-}
...
=Exemplos 
>>> transposta [[Plataforma,Vazio,Alcapao],[Escada,Escada,Vazio],[Escada,Plataforma,Vazio]] = [[Plataforma,Escada,Escada],[Vazio,Escada,Plataforma],[Alcapao,Vazio,Vazio]]
-}
...
=Exemplos
>>>validaPosicaoMapa (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Vazio,Vazio,Vazio],[Plataforma,Alcapao,Escada],[Vazio,Vazio,Plataforma]],inimigos = [Personagem {posicao = (0,0)}, Personagem {posicao = (2,0)}],colecionaveis = [(Martelo,(1,0)),(Moeda,(0,2))]}) = True
>>>validaPosicaoMapa (Jogo {mapa = Mapa ((1,1),Norte) (1,2) [[Vazio,Vazio,Vazio],[Plataforma,Alcapao,Escada],[Vazio,Vazio,Plataforma]],inimigos = [Personagem {posicao = (0,0)}, Personagem {posicao = (2,0)}],colecionaveis = [(Martelo,(1,0)),(Moeda,(0,2))]}) = False
>>>validaPosicaoMapa (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Vazio,Vazio,Vazio],[Plataforma,Alcapao,Escada],[Vazio,Vazio,Plataforma]],inimigos = [Personagem {posicao = (1,1)},Personagem {posicao = (2,0)}],colecionaveis = [(Martelo,(1,0)),(Moeda,(0,2))]}) = False
>>>validaPosicaoMapa (Jogo {mapa = Mapa ((1,2),Norte) (1,2) [[Vazio,Vazio,Vazio],[Plataforma,Alcapao,Escada],[Vazio,Vazio,Plataforma]],inimigos = [Personagem {posicao = (0,0)}, Personagem {posicao = (2,0)}],colecionaveis = [(Martelo,(1,1)),(Moeda,(0,2))]}) = False
-}
...
=Exemplos
>>>validaPosicaoMapaInimigos (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Alcapao,Vazio],[Vazio,Vazio,Vazio]],inimigos = [Personagem {posicao = (2,0)},Personagem {posicao = (0,0)}]}) = True
>>>validaPosicaoMapaInimigos (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Alcapao,Vazio],[Vazio,Vazio,Vazio]],inimigos = [Personagem {posicao = (0,1)},Personagem {posicao = (2,0)}]}) = False
>>>validaPosicaoMapaInimigos (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Alcapao,Vazio],[Vazio,Vazio,Vazio]],inimigos = [Personagem {posicao = (2,0)},Personagem {posicao = (1,1)}]})= False 
-}
...
=Exemplos
>>>validaPosicaoMapaColecionaveis (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Alcapao,Vazio],[Vazio,Vazio,Vazio]],colecionaveis = [(Martelo,(1,0)), (Moeda,(2,0))]}) = True
>>>validaPosicaoMapaColecionaveis (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Alcapao,Vazio],[Vazio,Vazio,Vazio]],colecionaveis = [(Martelo,(1,1)), (Moeda,(0,0))]}) = False
>>>validaPosicaoMapaColecionaveis (Jogo {mapa = Mapa ((2,0),Norte) (1,2) [[Vazio,Vazio,Escada],[Plataforma,Alcapao,Vazio],[Vazio,Vazio,Vazio]],colecionaveis = [(Martelo,(2,0)), (Moeda,(0,1))]}) = False
-}
